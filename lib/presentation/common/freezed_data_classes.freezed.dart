...
class _$LoginObjectTearOff {
  ...
  _LoginObject call(String emaile, String password) {
    return _LoginObject(
      emaile,
      password,
    );
...
/// @nodoc
mixin _$LoginObject {
  String get emaile => throw _privateConstructorUsedError;
...
abstract class $LoginObjectCopyWith<$Res> {
  ...
  $Res call({String emaile, String password});
}
...
class _$LoginObjectCopyWithImpl<$Res> implements $LoginObjectCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? emaile = freezed,
    Object? password = freezed,
  }) {
    return _then(_value.copyWith(
      emaile: emaile == freezed
          ? _value.emaile
          : emaile // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_LoginObject implements _LoginObject {
  _$_LoginObject(this.emaile, this.password);
  ...
  @override
  String toString() {
    return 'LoginObject(emaile: $emaile, password: $password)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.emaile, emaile) || other.emaile == emaile) &&
            (identical(other.password, password) ||
                other.password == password));
  }

  @override
  int get hashCode => Object.hash(runtimeType, emaile, password);
...
abstract class _LoginObject implements LoginObject {
  factory _LoginObject(String emaile, String password) = _$_LoginObject;
