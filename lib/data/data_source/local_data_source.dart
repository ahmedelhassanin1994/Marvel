...
import 'package:mvvm_project/data/responeses/response_characters/response_characters.dart';
...
class LocalDataSourceImplementer implements LocalDataSource{
  ...
  Future<List<Model_Cache>> getCache() async{
    ...
    print("fffff ${model_cache.value}");
    print("fffff ${model_cache.key}");
    var response= Response_Characters.fromJson(json.decode(model_cache.value));
    print("fffff ${response.status}");
